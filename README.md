...
- **Meal Generation**: Utilises Google Gemini AI to generate meals based on selected ingredients
...
APIs: [`TheMealDb`](https://www.themealdb.com/api.php), [`Spoonacular`](https://spoonacular.com/food-api), [`Google Gemini`](https://ai.google.dev/?authuser=1)
